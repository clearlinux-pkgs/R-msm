...
Version  : 1.6.9
Release  : 36
URL      : https://cran.r-project.org/src/contrib/msm_1.6.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/msm_1.6.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641063648
